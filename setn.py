...
#
battle_n = int(config.get('SetN', 'battle_n', fallback='37'))
camp_n = int(config.get('SetN', 'camp_n', fallback='38'))
dungeon_n = int(config.get('SetN', 'dungeon_n', fallback='37'))
event_n = int(config.get('SetN', 'event_n', fallback='38'))
facility_n = int(config.get('SetN', 'facility_n', fallback='37'))
init_n = int(config.get('SetN', 'init_n', fallback='40'))
shared_n = int(config.get('SetN', 'shared_n', fallback='38'))
tutorial_n = int(config.get('SetN', 'tutorial_n', fallback='52'))
default_n = int(config.get('SetN', 'default_n', fallback='38'))
